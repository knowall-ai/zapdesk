...
| `KNOWALL_LOGO_URL`                        | URL of the KnowAll AI logo for the outbound email footer. Unset, the footer shows a "Powered by KnowAll AI" wordmark instead — there is no logo asset in this repo | No (default: unset)                               |
