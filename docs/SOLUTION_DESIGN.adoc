...
The Explorer container visually represents the Feature's completion percentage:

* **100%+ full**: Blocks fill the entire container
* **50% full**: Blocks fill approximately half the container
* Based on `completedWork / effort` ratio
