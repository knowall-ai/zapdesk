...
For testing and demonstration purposes, DevDesk includes scripts to populate an Azure DevOps project with realistic dummy data.
...
* **Support tickets** are tagged with `ticket` and appear in DevDesk
